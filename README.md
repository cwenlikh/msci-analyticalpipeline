...
(3) **Gene-gene relationship inference**, via comparing scNET-inferred gene importance with changes in each gene's connectivity following scNET integration (termed as “neighbourhood analysis”). 
